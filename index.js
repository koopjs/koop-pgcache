...
module.exports = {
  ...
  connect: function (conn, koop, callback) {
    ...
    this.client.connect(function (err) {
      if (err) {
        ...
        // Inject dependencies
        [Indexes, Table, Geohash, Select].forEach(function (lib) {
          lib.query = self.query.bind(self);
        });
  ...
  createExportStream: function (table, options) {
    return ExportStream.create(this.conn, table, options);
  },
